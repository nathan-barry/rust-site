        ...
        div {
            ...
            div {
                ...
                TextBox {
                    ...
                    p { 
                        "The great thing about life is that I happen to be solely in what I'm studying. I find systems engineering and pure math (and really nearly anything CS or math-related) to be incredibly fascinating topics. I take as many classes as I can manage just because I find learning the most awe-inspiring activity one can do. Every semester I'm amazed at how much I don't know but yet how much I can learn. While I can't know everything, I'll damn well try."
                    }
                    p { "With whatever free time I do have, I enjoy working in rust. It is a beautiful language with beautiful tooling." }
                }
            }
            div {
